...
class DashboardDataService
{
    public function intern(int $userId): array
    {
        ...
        return [
            ...
            'navigation' => [
                ['label' => 'Dashboard', 'icon' => '⌂', 'active' => true, 'badge' => null, 'href' => '/dashboard'],
                ['label' => 'My Schedule', 'icon' => '◴', 'active' => false, 'badge' => null, 'href' => '/booking'],
                ['label' => 'My Clients', 'icon' => '♧', 'active' => false, 'badge' => null],
                ['label' => 'Sessions', 'icon' => '◎', 'active' => false, 'badge' => null, 'href' => '/video'],
                ['label' => 'Session Notes', 'icon' => '▧', 'active' => false, 'badge' => null],
                ['label' => 'Credential Vault', 'icon' => '▣', 'active' => false, 'badge' => 'Review', 'href' => '/credentials'],

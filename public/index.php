...
} elseif ($path === '/video' && $method === 'GET') {
    (new VideoConsultationController())->index();
} elseif ($path === '/video/data' && $method === 'GET') {
    (new VideoConsultationController())->data();
} elseif ($path === '/video/device-check' && $method === 'POST') {
    (new VideoConsultationController())->deviceCheck();
} elseif ($path === '/video/consent' && $method === 'POST') {
    (new VideoConsultationController())->consent();
} elseif ($path === '/video/chat' && $method === 'POST') {
    (new VideoConsultationController())->chat();
} elseif ($path === '/video/notes' && $method === 'POST') {
    (new VideoConsultationController())->notes();
} elseif ($path === '/video/ai-summary' && $method === 'POST') {
    (new VideoConsultationController())->aiSummary();

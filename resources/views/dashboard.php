    ...
    <aside class="sidebar" aria-label="Primary navigation">
        ...
        <nav>
            <?php foreach ($data['navigation'] as $item): ?>
                <a class="<?= $item['active'] ? 'active' : '' ?>" href="<?= h($item['href'] ?? '#') ?>">
    ...
    <main class="content">
        ...
        <section class="dashboard-grid">
            <article class="card wide schedule-card">
                ...
                <?php endforeach; ?>
                <a class="link" href="<?= h($item['href'] ?? '#') ?>">View Full Schedule →</a>
            </article>
            ...
            <article class="card recent-card">
                ...
                <?php endforeach; ?>
                <a class="link" href="<?= h($item['href'] ?? '#') ?>">View All Sessions →</a>
            </article>
            ...
            <article class="card wallet">
                ...
                <a class="link" href="<?= h($item['href'] ?? '#') ?>">View Earnings Breakdown →</a>
            </article>
            ...
            <article class="card cpd">
                ...
                <a class="link" href="<?= h($item['href'] ?? '#') ?>">Continue Learning →</a>
            </article>
...
<nav class="mobile-nav" aria-label="Mobile navigation"><a href="<?= h($item['href'] ?? '#') ?>">⌂<span>Home</span></a><a href="<?= h($item['href'] ?? '#') ?>">◴<span>Schedule</span></a><a href="<?= h($item['href'] ?? '#') ?>">◉<span>Bonus</span></a><a href="<?= h($item['href'] ?? '#') ?>">☑<span>CPD</span></a></nav>
</body>
</html>
